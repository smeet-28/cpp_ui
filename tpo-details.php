                            ...
                            <div class="panel-body">
                                <div class="col-sm-10">
                                    ...
                                    <div class="modal-body"> 
                                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="" id="companyDetails">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6 controls">
                                                    <textarea name="address" id="" cols="10" rows="4"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="modal-body"> 
                                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="" id="companyDetails">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="attach">Attachements : </label>
                                                <div class="col-sm-6 controls">
                                                    <input class="input-border-btm" type="file" name="announcement_attach[]" multiple="multiple" id="attach">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
$(document).ready(function() {
  ...
  $('#filters').on( 'click', 'a', function() {
    ...
    show_for_company_details_entry(); 
    function show_for_company_details_entry(){
        ...
        //alert(id);
            ...
            //showing company details table on ui
            function show_company_details_table(id)
            {
                      ...
                      $.ajax({
                                ...
                                success : function(response){
                                    ...
                                    //console.log("'" + c_new.json_type + "'");
                                    var c = JSON.parse(c_new.json_type);
                                    //console.log(c);
                                    ///var id = data.id;
                                   /* var json_type = data.json_type;*/
                                    /*var hy = JSON.stringify(json_type);*/
//                                    var c = JSON.parse(json_type);
                                    //var c = JSON.parse(json_type);
                                   // var f = JSON.parse(attach);
                                   // alert(c.description);
                                    var html = '<br>'+'<table class="table table-bordered">'+
                                        ...
                                        '<input type="text" placeholder="CGPI > 6.5" class="width-50">'+'</div>'+'</div>'+'<br>'+'<br>'+'<br>'+
                                        '<div class="form-group">'+
                                        '<label class="col-sm-3 control-label">UG</label>'+
                                        '<div class="col-sm-7 controls">'+
                                        '<div class="vd_checkbox checkbox-danger">'+
                                        '<input type="checkbox" value="" id="checkbox-3">'+
                                        '<label for="checkbox-3"> COMPS </label>'+
                                        '<input type="checkbox" value="" id="checkbox-4">'+
                                        '<label for="checkbox-4"> IT </label>'+
                                        '<input type="checkbox" value="" id="checkbox-5">'+
                                        '<label for="checkbox-5"> ETRX </label>'+
                                        '<input type="checkbox" value="" id="checkbox-6">'+
                                        '<label for="checkbox-6"> EXTC </label>'+
                                        '<input type="checkbox" value="" id="checkbox-7">'+
                                        ...
                                        '<div class="col-sm-7 controls">'+
                                        '<div class="vd_checkbox checkbox-danger">'+
                                        '<input type="checkbox" value="" id="checkbox-8">'+
                                        '<label for="checkbox-8"> COMPS </label>'+
                                        '<input type="checkbox" value="" id="checkbox-9">'+
                                        '<label for="checkbox-9"> IS </label>'+
                                        '<input type="checkbox" value="" id="checkbox-10">'+
                                        '<label for="checkbox-10"> ETRX </label>'+
                                        '<input type="checkbox" value="" id="checkbox-11">'+
                                        '<label for="checkbox-11"> EXTC </label>'+
                                        '<input type="checkbox" value="" id="checkbox-12">'+
                                        ...
                                        '<option>Dream &amp; Non Dream</option>'+
                                        '</select>'+'</div>'+'</div>'+'<br>'+'<br>'+
                                        '<button class="btn btn-primary " data-toggle="modal" data-target="" id=""> Send Mail</button>'+
                                        '</div>';
                                     $('#displayCompanyDetails').html(html);
                            }
                            });
            }
});
...
//adding company details to the database;
